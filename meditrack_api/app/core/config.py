...
class Settings(BaseSettings):
    ...
    # AI Integration (Using HuggingFace Router API - keep GROK_ prefix for compatibility)
    GROK_API_KEY: str = Field(..., description="HuggingFace Router API key")
    GROK_API_BASE_URL: str = "https://router.huggingface.co/v1"
    GROK_MODEL: str = "meta-llama/Llama-3.1-8B-Instruct"
